...
""" Find all the FLAC files in the bird data folders and copy only then FLAC files to a new folder, while
preserving the folder structure.
Can be called with 2 command line parameters being the input and output directory respectively.
"""
